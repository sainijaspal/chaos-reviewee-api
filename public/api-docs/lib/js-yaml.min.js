  ...
  return (function e(t, n, i) {
  ...
  })(
    {
            ...
            if (
              ...
              if (
                ...
                i && Object.keys(t.dump).length !== 0
                  ...
                  : (y(t, e, t.dump), c && (t.dump = `&ref_${s} ${t.dump}`));
              else if (a === '[object Array]')
                i && t.dump.length !== 0
                  ? (g(t, e, t.dump, r), c && (t.dump = `&ref_${s}${t.dump}`))
        ...
        function(t, e, n) {
          ...
          function v(t, e, n, i, r) {
            ...
            if (
              ...
              if (Array.isArray(r))
                for (o = 0, a = r.length; a > o; o += 1) y(t, e, r[o]);
              else y(t, e, r);
            else e[i] = r;
            return e;
          }
          ...
          function k(t, e, n) {
            ...
            return (
              g(t, u, l, !1), t.result ? !0 : ((t.kind = y), (t.result = v), !1)
            );
          }
          function C(t, e) {
            let n;
            ...
            for (
              ...
              if (n === 39) {
                ...
                i(n)
                  ? (g(t, r, o, !0), w(t, A(t, !1, e)), (r = o = t.position))
          ...
          function j(t, e) {
            ...
            for (
              ...
              if (l === 34) return g(t, n, t.position, !0), t.position++, !0;
              if (l === 92) {
                if (
                  (g(t, n, t.position, !0),
                ...
                i(l)
                  ? (g(t, n, r, !0), w(t, A(t, !1, e)), (n = r = t.position))
                  : t.position === t.lineStart && b(t)
                  ? d(
                      t,
            ...
            for (
              ...
              if (
                ((t.line === s || t.lineIndent > e) &&
                  (T(t, e, Z, !0, a) && (g ? (h = t.result) : (m = t.result)),
                  g || (v(t, p, f, h, m), (f = h = m = null)),
                  A(t, !0, -1),
                  (c = t.input.charCodeAt(t.position))),
                t.lineIndent > e && c !== 0)
              )
          ...
          function T(t, e, n, i, r) {
                    ...
                    t.result !== null &&
                      ...
                      d(
                        ...
                        `unacceptable node kind for !<${
                          t.tag
                        }> tag; it should be "${l.kind}", not "${t.kind}"`,
                      ),
                    l.resolve(t.result)
                      ? ((t.result = l.construct(t.result)),
                        t.anchor !== null && (t.anchorMap[t.anchor] = t.result))
            ...
            return t.tag !== null || t.anchor !== null || g;
          }
          function M(t) {
            let e;
            let n;
          ...
          function L(t, e) {
            ...
            const n = new f(t, e);
            for (n.input += '\x00'; n.input.charCodeAt(n.position) === 32; )
      ...
      29: [
        function(t, e, n) {
          function i(t) {
            return t === null ? !1 : s.exec(t) === null ? !1 : !0;
          }
          function r(t) {
            let e;
            let n;
          ...
          !(function(e) {
            ...
            function o(t, e, n) {
              for (var i, o, a = r(n), s = 0, u = a.length; u > s; )
                (i = a[s++]) !== '__self' &&
                  ((o = n[i]),
                  g(o) && (!c || o.toString().indexOf('.__base') > -1)
                    ? (e[i] = (function(n, i) {
                        const r = t[n]
                          ? t[n]
                          : n === '__constructor'
              ...
              for (var n, i = 1; (n = t[i++]); )
                e
                  ? g(n)
                    ...
                    : s.self(e, n)
                  : (e = g(n) ? s(t[0], n.prototype, n) : s(t[0], n));
              return e || t[0];
            }
            function s() {
              const t = arguments;
