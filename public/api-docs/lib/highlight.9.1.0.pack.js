...
!(function(e) {
  ...
  function l(e, t, a, i) {
    ...
    function d() {
      ...
      const t = e ? l(L.sL, M, !0, y[L.sL]) : f(M, L.sL.length ? L.sL : void 0);
      return (
        L.r > 0 && (B += t.r),
        e && (y[L.sL] = t.top),
    ...
    try {
      ...
      if (O.message.indexOf('Illegal') != -1) return { r: 0, value: n(t) };
      throw O;
    }
  }
  function f(e, t) {
...
hljs.registerLanguage('json', function(e) {
  ...
  const n = { b: '\\[', e: '\\]', c: [e.inherit(r)], i: '\\S' };
  return i.splice(i.length, 0, s, n), { c: i, k: t, i: '\\S' };
});
hljs.registerLanguage('xml', function(s) {
  const t = '[A-Za-z0-9\\._:-]+';
  const e = { b: /<\?(php)?(?!\w)/, e: /\?>/, sL: 'php' };
  const r = {
    eW: !0,
    i: /</,
    r: 0,
