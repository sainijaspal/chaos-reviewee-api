...
!(function() {
            ...
            c.test(a[g])
              ? (function(a, b) {
                  return function() {
                    const c = this._super;
                    this._super = e[a];
                    const d = b.apply(this, arguments);
    ...
    (function() {
      ...
      window.requestAnimationFrame ||
        (window.requestAnimationFrame = function(b, c) {
          ...
          const e = Math.max(0, 16 - (d - a));
          const f = window.setTimeout(function() {
            b(d + e);
          }, e);
          return (a = d + e), f;
        }),
  ...
  const b = function(a) {
    return typeof a !== 'object' || a.nodeType || (a !== null && a === a.window)
      ? !1
      : a.constructor &&
  ...
  var c = function(a) {
    ...
    for (e = 1; e < arguments.length; e++) {
      ...
      for (f in d)
        d.hasOwnProperty(f) &&
          (d[f] && b(d[f])
            ? (a.hasOwnProperty(f) || (a[f] = {}), c(a[f], d[f]))
            : (a[f] = d[f]));
    }
    return a;
  };
  const d = function(a, b) {
    if (a && typeof a === 'object') {
      ...
      if (
        Array.isArray(a) ||
        (typeof a.length === 'number' && a.length > 0 && a.length - 1 in a)
      ) {
  ...
  (f.prototype = {
    ...
    init() {
      const a = this;
      this.ready = !1;
      const b = f.defaults.themes[this.options.theme || f.defaults.theme];
      ...
      (this.schema = this.options.schema),
        ...
        (this.uuid = 0),
        (this.__data = {});
      const c = f.defaults.iconlibs[this.options.iconlib || f.defaults.iconlib];
      c && (this.iconlib = new c()),
        (this.root_container = this.theme.getContainer()),
        this.element.appendChild(this.root_container),
        (this.translate = this.options.translate || f.defaults.translate),
        this._loadExternalRefs(this.schema, function() {
          a._getDefinitions(a.schema), (a.validator = new f.Validator(a));
          const b = a.getEditorClass(a.schema);
          (a.root = a.createEditor(b, {
            jsoneditor: a,
            schema: a.schema,
            required: !0,
    ...
    trigger(a) {
      if (this.callbacks && this.callbacks[a] && this.callbacks[a].length)
        for (let b = 0; b < this.callbacks[a].length; b++)
          this.callbacks[a][b]();
      return this;
    },
    setOption(a, b) {
    ...
    getEditorClass(a) {
      ...
      if (
        ...
        d(f.defaults.resolvers, function(c, d) {
          const e = d(a);
          return e && f.defaults.editors[e] ? ((b = e), !1) : void 0;
        }),
        !b)
      )
    ...
    registerEditor(a) {
      return (
        (this.editors = this.editors || {}), (this.editors[a.path] = a), this
      );
    },
    unregisterEditor(a) {
      return (
        (this.editors = this.editors || {}), (this.editors[a.path] = null), this
      );
    },
    getEditor(a) {
      return this.editors ? this.editors[a] : void 0;
    },
    watch(a, b) {
      return (
    ...
    notifyWatchers(a) {
      if (!this.watchlist || !this.watchlist[a]) return this;
      for (let b = 0; b < this.watchlist[a].length; b++) this.watchlist[a][b]();
    },
    isEnabled() {
    ...
    _getExternalRefs(a) {
      const b = {};
      const c = function(a) {
        for (const c in a) a.hasOwnProperty(c) && (b[c] = !0);
      };
      a.$ref &&
        typeof a.$ref !== 'object' &&
        a.$ref.substr(0, 1) !== '#' &&
      ...
      for (const d in a)
        if (a.hasOwnProperty(d))
          if (a[d] && typeof a[d] === 'object' && Array.isArray(a[d]))
            for (let e = 0; e < a[d].length; e++)
              typeof a[d][e] === 'object' && c(this._getExternalRefs(a[d][e]));
          else
            a[d] && typeof a[d] === 'object' && c(this._getExternalRefs(a[d]));
      return b;
    },
    _loadExternalRefs(a, b) {
      const c = this;
      const e = this._getExternalRefs(a);
      let f = 0;
      let g = 0;
      let h = !1;
      d(e, function(a) {
        ...
        (typeof a.type === 'object' &&
          (Array.isArray(a.type)
            ? d(a.type, function(b, c) {
                typeof c === 'object' && (a.type[b] = e.expandSchema(c));
              })
            : (a.type = e.expandSchema(a.type))),
        typeof a.disallow === 'object' &&
          (Array.isArray(a.disallow)
            ? d(a.disallow, function(b, c) {
                typeof c === 'object' && (a.disallow[b] = e.expandSchema(c));
              })
      ...
      return (
        d(a, function(a, c) {
          typeof b[a] !== 'undefined'
            ? a === 'required' && typeof c === 'object' && Array.isArray(c)
              ? (f.required = c.concat(b[a]).reduce(function(a, b) {
                  return a.indexOf(b) < 0 && a.push(b), a;
                }, []))
              : a !== 'type' || (typeof c !== 'string' && !Array.isArray(c))
              ? typeof c === 'object' && Array.isArray(c)
                ...
                : (f[a] = c)
              : (typeof c === 'string' && (c = [c]),
                typeof b.type === 'string' && (b.type = [b.type]),
                (f.type = c.filter(function(a) {
                  return b.type.indexOf(a) !== -1;
                })),
                f.type.length === 1 &&
                  typeof f.type[0] === 'string' &&
                  (f.type = f.type[0]))
            : (f[a] = c);
        }),
        d(b, function(b, c) {
          typeof a[b] === 'undefined' && (f[b] = c);
        }),
        f
      );
    },
    ...
    (f.Validator = a.extend({
      ...
      _validateSchema(a, b, e) {
        let g;
        let h;
        let i;
        const j = this;
        let k = [];
        const l = JSON.stringify(b);
        if (
          ((e = e || 'root'),
        ...
        if (a.oneOf) {
          ...
          for (h = 0; h < a.oneOf.length; h++) {
            const n = this._validateSchema(a.oneOf[h], b, e);
        ...
        if (typeof b === 'number')
          (a.multipleOf || a.divisibleBy) &&
            ((g = b / (a.multipleOf || a.divisibleBy)),
            g !== Math.floor(g) &&
              k.push({
                path: e,
            ...
            a.hasOwnProperty('maximum') &&
              (a.exclusiveMaximum && b >= a.maximum
                ? k.push({
                    path: e,
                    property: 'maximum',
                    message: this.translate('error_maximum_excl', [a.maximum]),
                  })
                : !a.exclusiveMaximum &&
                  b > a.maximum &&
                  k.push({
                    path: e,
                    property: 'maximum',
                    message: this.translate('error_maximum_incl', [a.maximum]),
                  })),
            a.hasOwnProperty('minimum') &&
              (a.exclusiveMinimum && b <= a.minimum
                ? k.push({
                    path: e,
                    property: 'minimum',
                    message: this.translate('error_minimum_excl', [a.minimum]),
                  })
                : !a.exclusiveMinimum &&
                  b < a.minimum &&
                  k.push({
                    path: e,
                    property: 'minimum',
                    message: this.translate('error_minimum_incl', [a.minimum]),
                  }));
            ...
            a.minLength &&
              ...
              k.push({
                ...
                message: this.translate(
                  a.minLength === 1 ? 'error_notempty' : 'error_minLength',
                  [a.minLength],
                ),
              }),
            a.pattern &&
          ...
          if (a.items)
            if (Array.isArray(a.items))
              for (h = 0; h < b.length; h++)
                if (a.items[h])
                  k = k.concat(
                    this._validateSchema(a.items[h], b[h], `${e}.${h}`),
                  );
                else {
                  ...
                  k = k.concat(
                    this._validateSchema(a.additionalItems, b[h], `${e}.${h}`),
                  );
                }
            else
              for (h = 0; h < b.length; h++)
          ...
          if (a.required && Array.isArray(a.required))
            for (h = 0; h < a.required.length; h++)
              typeof b[a.required[h]] === 'undefined' &&
                k.push({
                  path: e,
                  property: 'required',
          ...
          if (a.properties)
            for (h in a.properties)
              a.properties.hasOwnProperty(h) &&
                ((p[h] = !0),
                (k = k.concat(
                  this._validateSchema(a.properties[h], b[h], `${e}.${h}`),
                )));
          ...
          if (
            (typeof a.additionalProperties !== 'undefined' ||
              ...
              if (
                ...
                if (Array.isArray(a.dependencies[h]))
                  for (i = 0; i < a.dependencies[h].length; i++)
                    typeof b[a.dependencies[h][i]] === 'undefined' &&
                      k.push({
                        path: e,
                  ...
                  k = k.concat(this._validateSchema(a.dependencies[h], b, e));
        }
        return (
      ...
      _checkType(a, b) {
        return typeof a === 'string'
          ? a === 'string'
            ...
            ? typeof b === 'number'
            : a === 'integer'
            ? typeof b === 'number' && b === Math.floor(b)
            : a === 'boolean'
            ? typeof b === 'boolean'
            : a === 'array'
            ? Array.isArray(b)
            : a === 'object'
            ? b !== null && !Array.isArray(b) && typeof b === 'object'
            : a === 'null'
            ? b === null
            : !0
    ...
    (f.AbstractEditor = a.extend({
      ...
      setupWatchListeners() {
        ...
        if (
          ...
          let e;
          let f;
          for (const g in this.schema.watch)
            if (this.schema.watch.hasOwnProperty(g)) {
              if (
                ((b = this.schema.watch[g]),
                Array.isArray(b)
                  ? (c = [b[0]].concat(b[1].split('.')))
                  : ((c = b.split('.')),
                    a.theme.closest(a.container, `[data-schemaid="${c[0]}"]`) ||
                      c.unshift('#')),
                (d = c.shift()),
      ...
      addLinks() {
        if (
          ...
          for (let a = 0; a < this.schema.links.length; a++)
            this.addLink(this.getLink(this.schema.links[a]));
      },
      getButton(a, b, c) {
        const d = `json-editor-btn-${b}`;
        (b = this.iconlib ? this.iconlib.getIcon(b) : null),
          !b && c && ((a = c), (c = null));
        const e = this.theme.getButton(a, b, c);
        return (e.className += ` ${d} `), e;
      },
      setButtonText(a, b, c, d) {
        return (
      ...
      getLink(a) {
        let b;
        let c;
        const d = a.mediaType || 'application/javascript';
        const e = d.split('/')[0];
        const f = this.jsoneditor.compileTemplate(a.href, this.template_engine);
        if (e === 'image') {
          (b = this.theme.getBlockLinkHolder()),
            (c = document.createElement('a')),
            c.setAttribute('target', '_blank');
          const g = document.createElement('img');
          this.theme.createImageLink(b, c, g),
          ...
          h.setAttribute('controls', 'controls'),
            this.theme.createMediaLink(b, c, h),
            this.link_watchers.push(function(b) {
              const d = f(b);
              c.setAttribute('href', d),
      ...
      updateHeaderText() {
        if (this.header)
          if (this.header.children.length) {
            for (let a = 0; a < this.header.childNodes.length; a++)
              if (this.header.childNodes[a].nodeType === 3) {
      ...
      getDefault() {
        ...
        let a = this.schema.type || this.schema.oneOf;
        if (
          (a && Array.isArray(a) && (a = a[0]),
          a && typeof a === 'object' && (a = a.type),
          a && Array.isArray(a) && (a = a[0]),
          typeof a === 'string')
        ) {
      ...
      getDisplayText(a) {
        ...
        d(a, function(a, b) {
          b.title && ((c[b.title] = c[b.title] || 0), c[b.title]++),
            b.description &&
              ((c[b.description] = c[b.description] || 0), c[b.description]++),
      ...
      build() {
        ...
        if (
          ...
          if (this.format === 'textarea')
            ...
            let b = this.schema.minimum || 0;
            let c = this.schema.maximum || Math.max(100, b + 1);
            let d = 1;
            ...
            ((this.adjust_height = function(a) {
              if (a) {
                ...
                if (a.offsetHeight < a.scrollHeight)
                  for (
                    b = 0;
                    a.offsetHeight < a.scrollHeight + 3 && !(b > 100);
        ...
        if (this.source_code)
          if (
            ...
            (a = c(
              {},
              {
                plugins: b.input_type === 'html' ? 'xhtml' : 'bbcode',
                emoticonsEnabled: !1,
                width: '100%',
                height: 300,
              },
              ...
              b.sceditor_instance.blur(function() {
                const a = window.jQuery(
                  `<div>${b.sceditor_instance.val()}</div>`,
                );
                window
                  .jQuery(
            ...
            (this.epiceditor_container = document.createElement('div')),
              ...
              this.epiceditor.on('update', function() {
                const a = b.epiceditor.exportFile();
                (b.input.value = a),
                  (b.value = a),
                  (b.is_dirty = !0),
                  b.onChange(!0);
            ...
            let d = this.input_type;
            (d === 'cpp' || d === 'c++' || d === 'c') && (d = 'c_cpp'),
    ...
    (f.defaults.editors.object = f.AbstractEditor.extend({
        ...
        if (this.row_container) {
          (this.property_order = Object.keys(this.editors)),
            (this.property_order = this.property_order.sort(function(a, b) {
              let d = c.editors[a].schema.propertyOrder;
              let e = c.editors[b].schema.propertyOrder;
              return (
                typeof d !== 'number' && (d = 1e3),
                typeof e !== 'number' && (e = 1e3),
                d - e
              );
            }));
          let e;
          if (this.format === 'grid') {
            ...
            for (
                ...
                if (!d.property_removed) {
                  for (
                    var e = !1,
                      g = d.options.hidden
                        ? 0
                        : d.options.grid_columns || d.getNumColumns(),
                    ...
                    f[i].width + g <= 12 &&
                      ...
                      (e = i);
                  e === !1 &&
                    (f.push({ width: 0, minh: 999999, maxh: 0, editors: [] }),
                    (e = f.length - 1)),
                    f[e].editors.push({ key: b, width: g, height: h }),
                    (f[e].width += g),
              ...
              if (f[a].width < 12) {
                ...
                for (b = 0; b < f[a].editors.length; b++)
                  g === !1
                    ? (g = b)
                    : f[a].editors[b].width > f[a].editors[g].width && (g = b),
            ...
            for (
              ...
              const i = this.theme.getGridRow();
              for (e.appendChild(i), b = 0; b < f[a].editors.length; b++) {
                const j = f[a].editors[b].key;
                const k = this.editors[j];
                k.options.hidden
      ...
      getPropertySchema(a) {
        let b = this.schema.properties[a] || {};
        b = c({}, b);
        let d = this.schema.properties[a] ? !0 : !1;
        if (this.schema.patternProperties)
          for (const e in this.schema.patternProperties)
      ...
      preBuild() {
        ...
        if (
          ...
          d(this.schema.properties, function(b, c) {
            const d = a.jsoneditor.getEditorClass(c);
            ...
            const e = a.editors[b].options.hidden
              ? 0
          ...
          (this.defaultProperties =
            ...
            (a.maxwidth += 1),
            d(this.defaultProperties, function(b, c) {
        ...
        (this.property_order = Object.keys(this.editors)),
          (this.property_order = this.property_order.sort(function(b, c) {
            let d = a.editors[b].schema.propertyOrder;
            let e = a.editors[c].schema.propertyOrder;
            return (
              typeof d !== 'number' && (d = 1e3),
              typeof e !== 'number' && (e = 1e3),
              d - e
              ...
              b.preventDefault(),
                ...
                a.collapsed
                  ...
                  : ((a.editor_holder.style.display = 'none'),
                    (a.collapsed = !0),
                    a.setButtonText(a.toggle_button, '', 'expand', 'Expand'));
            }),
      ...
      showEditJSON() {
        this.editjson_holder &&
          ...
          (this.editjson_holder.style.left = `${
            this.editjson_button.offsetLeft
          }px`),
          (this.editjson_holder.style.top = `${this.editjson_button.offsetTop +
            this.editjson_button.offsetHeight}px`),
      ...
      saveJSON() {
        if (this.editjson_holder)
          try {
            const a = JSON.parse(this.editjson_textarea.value);
      ...
      insertPropertyControlUsingPropertyOrder(a, b, c) {
        let d;
        this.schema.properties[a] &&
          (d = this.schema.properties[a].propertyOrder),
          typeof d !== 'number' && (d = 1e3),
          (b.propertyOrder = d);
        for (let e = 0; e < c.childNodes.length; e++) {
          const f = c.childNodes[e];
      ...
      addPropertyCheckbox(a) {
        ...
        return (
          ...
          b.addEventListener('change', function() {
            b.checked ? f.addObjectProperty(a) : f.removeObjectProperty(a),
              f.onChange(!0);
          }),
      ...
      showAddProperty() {
        this.addproperty_holder &&
          ...
          (this.addproperty_holder.style.top = `${this.addproperty_button
            .offsetTop + this.addproperty_button.offsetHeight}px`),
          this.disable(),
        ...
        if (!this.editors[a]) {
          if (this.cached_editors[a]) {
            ...
            if (
              ...
              return;
            const d = c.getPropertySchema(a);
            const e = c.jsoneditor.getEditorClass(d);
            if (
              ...
              const f = c.theme.getChildEditorHolder();
      ...
      getValue() {
        ...
        if (
          ...
          for (const b in a) a.hasOwnProperty(b) && (a[b] || delete a[b]);
        return a;
      },
      refreshValue() {
        this.value = {};
        ...
        for (a in this.cached_editors)
          this.cached_editors.hasOwnProperty(a) &&
            ...
            d <= this.schema.minProperties
              ? ((this.addproperty_checkboxes[
                  a
                ].disabled = this.addproperty_checkboxes[a].checked),
      ...
      isRequired(a) {
        return typeof a.schema.required === 'boolean'
          ? a.schema.required
    ...
    (f.defaults.editors.array = f.AbstractEditor.extend({
      ...
      register() {
        if ((this._super(), this.rows))
          for (let a = 0; a < this.rows.length; a++) this.rows[a].register();
      },
      unregister() {
        if ((this._super(), this.rows))
          for (let a = 0; a < this.rows.length; a++) this.rows[a].unregister();
      },
      getNumColumns() {
        const a = this.getItemInfo(0);
      ...
      getItemTitle() {
        if (!this.item_title)
          if (this.schema.items && !Array.isArray(this.schema.items)) {
            const a = this.jsoneditor.expandRefs(this.schema.items);
      ...
      getItemInfo(a) {
        let b = this.getItemSchema(a);
        this.item_info = this.item_info || {};
        const c = JSON.stringify(b);
        return typeof this.item_info[c] !== 'undefined'
          ? this.item_info[c]
      ...
      getElementEditor(a) {
        const b = this.getItemInfo(a);
        let c = this.getItemSchema(a);
        (c = this.jsoneditor.expandRefs(c)), (c.title = `${b.title} ${a + 1}`);
        let d;
        const e = this.jsoneditor.getEditorClass(c);
        (d = this.tabs_holder
        ...
        const f = this.jsoneditor.createEditor(e, {
      ...
      refreshValue(a) {
        const b = this;
        const c = this.value ? this.value.length : 0;
        if (
          ((this.value = []),
      ...
      addRow(a, b) {
        ...
        const f = c.rows[e].title_controls || c.rows[e].array_controls;
        c.hide_delete_buttons ||
          ((c.rows[e].delete_button = this.getButton(
            c.getItemTitle(),
            'delete',
            `Delete ${c.getItemTitle()}`,
          )),
          ...
          c.rows[e].delete_button.addEventListener('click', function(a) {
            ...
            const b = 1 * this.getAttribute('data-i');
            const e = c.getValue();
            const f = [];
            let g = null;
            d(e, function(a, d) {
      ...
      addControls() {
        ...
        (this.collapsed = !1),
          (this.toggle_button = this.getButton('', 'collapse', 'Collapse')),
          this.title_controls.appendChild(this.toggle_button);
        const b = a.row_holder.style.display;
        const c = a.controls.style.display;
        this.toggle_button.addEventListener('click', function(d) {
          d.preventDefault(),
            ...
            a.collapsed
              ? ((a.collapsed = !1),
                ...
                a.setButtonText(this, '', 'collapse', 'Collapse'))
              : ((a.collapsed = !0),
                ...
                a.setButtonText(this, '', 'expand', 'Expand'));
        }),
          this.options.collapsed && e(this.toggle_button, 'click'),
          this.schema.options &&
          typeof this.schema.options.disable_collapse !== 'undefined'
          ...
          this.add_row_button.addEventListener('click', function(b) {
            ...
            const c = a.rows.length;
            a.row_cache[c]
              ? ((a.rows[c] = a.row_cache[c]),
                a.rows[c].setValue(a.rows[c].getDefault()),
    ...
    (f.defaults.editors.table = f.defaults.editors.array.extend({
      ...
      build() {
        ...
        const b = this.getElementEditor(0, !0);
        if (
          ...
          for (
            let c = b.getChildEditors(),
              d = b.property_order || Object.keys(c),
              e = 0;
            e < d.length;
            e++
          ) {
            const f = a.theme.getTableHeaderCell(c[d[e]].getTitle());
      ...
      getElementEditor(a, b) {
        const d = c({}, this.schema.items);
        const e = this.jsoneditor.getEditorClass(d, this.jsoneditor);
        const f = this.row_holder.appendChild(this.theme.getTableRow());
        let g = f;
        this.item_has_child_editors ||
          ((g = this.theme.getTableCell()), f.appendChild(g));
        const h = this.jsoneditor.createEditor(e, {
          jsoneditor: this.jsoneditor,
          schema: d,
          container: g,
          path: `${this.path}.${a}`,
      ...
      setValue(a, b) {
        ...
        if (c !== this.serialized) {
          ...
          for (let g = a.length; g < f.rows.length; g++) {
            const h = f.rows[g].container;
      ...
      addRow(a) {
        const b = this;
        const c = this.rows.length;
        b.rows[c] = this.getElementEditor(c);
        const e = b.rows[c].table_controls;
        this.hide_delete_buttons ||
          ((b.rows[c].delete_button = this.getButton('', 'delete', 'Delete')),
          ...
          b.rows[c].delete_button.addEventListener('click', function(a) {
            a.preventDefault(), a.stopPropagation();
            const c = 1 * this.getAttribute('data-i');
            const e = b.getValue();
            const f = [];
            d(e, function(a, b) {
              a !== c && f.push(b);
    ...
    (f.defaults.editors.multiple = f.AbstractEditor.extend({
      ...
      switchEditor(a) {
        const b = this;
        this.editors[a] || this.buildChildEditor(a), (b.type = a), b.register();
        const c = b.getValue();
      ...
      buildChildEditor(a) {
        const b = this;
        const d = this.types[a];
        const e = b.theme.getChildEditorHolder();
        ...
        const g = b.jsoneditor.getEditorClass(f);
      ...
      preBuild() {
        if (
          ...
          if (this.schema.type && this.schema.type !== 'any')
            ...
            let a = this.schema.disallow;
            (typeof a === 'object' && Array.isArray(a)) || (a = [a]);
            const b = [];
      ...
      build() {
        ...
        (this.header = this.label = this.theme.getFormInputLabel(
          ...
          d(this.types, function(b, d) {
            ...
            let e;
            typeof d === 'string'
              ? ((e = c({}, a.schema)), (e.type = d))
              : ((e = c({}, a.schema, d)),
                d.required &&
                  Array.isArray(d.required) &&
                  a.schema.required &&
                  Array.isArray(a.schema.required) &&
                  (e.required = a.schema.required.concat(d.required))),
              (a.validators[b] = new f.Validator(a.jsoneditor, e));
          }),
          this.switchEditor(0);
      },
      onChildEditorChange(a) {
      ...
      refreshHeaderText() {
        const a = this.getDisplayText(this.types);
      ...
      setValue(a, b) {
        ...
        d(this.validators, function(b, d) {
          return d.validate(a).length
            ? void 0
            : ((c.type = b), (c.switcher.value = c.display_text[b]), !1);
        }),
      ...
      showValidationErrors(a) {
        const b = this;
        this.oneOf
          ? d(this.editors, function(e, f) {
              if (f) {
                const g = `${b.path}.oneOf[${e}]`;
                const h = [];
                d(a, function(a, d) {
                  if (d.path.substr(0, g.length) === g) {
                    const e = c({}, d);
                    (e.path = b.path + e.path.substr(g.length)), h.push(e);
                  }
                }),
                  f.showValidationErrors(h);
              }
            })
          : d(this.editors, function(b, c) {
    ...
    (f.defaults.editors.enum = f.AbstractEditor.extend({
      ...
      refreshValue() {
        const a = this;
        a.selected = -1;
        const b = JSON.stringify(this.value);
        return (
          d(this.enum, function(c, d) {
            return b === JSON.stringify(d) ? ((a.selected = c), !1) : void 0;
          }),
          a.selected < 0
      ...
      getHTML(a) {
        const b = this;
        if (a === null) return '<em>null</em>';
        if (typeof a === 'object') {
          let c = '';
          return (
            d(a, function(d, e) {
              let f = b.getHTML(e);
              Array.isArray(a) || (f = `<div><em>${d}</em>: ${f}</div>`),
                (c += `<li>${f}</li>`);
            }),
            (c = Array.isArray(a)
              ? `<ol>${c}</ol>`
              : `<ul style='margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0;'>${c}</ul>`)
          );
        }
    ...
    (f.defaults.editors.select = f.AbstractEditor.extend({
      ...
      preBuild() {
        ...
        if (
          ...
          d(this.schema.enum, function(c, d) {
            (a.enum_options[c] = `${d}`),
              (a.enum_display[c] = `${b[c] || d}`),
              (a.enum_values[c] = a.typecast(d));
          }),
            this.isRequired() ||
          ...
          if (
            ...
            for (h = 0; h < this.schema.enumSource.length; h++)
              typeof this.schema.enumSource[h] === 'string'
                ? (this.enumSource[h] = { source: this.schema.enumSource[h] })
                : Array.isArray(this.schema.enumSource[h])
                ? (this.enumSource[h] = this.schema.enumSource[h])
                : (this.enumSource[h] = c({}, this.schema.enumSource[h]));
          else
          ...
          for (h = 0; h < this.enumSource.length; h++)
            this.enumSource[h].value &&
              (this.enumSource[h].value = this.jsoneditor.compileTemplate(
                this.enumSource[h].value,
                this.template_engine,
              )),
              this.enumSource[h].title &&
                (this.enumSource[h].title = this.jsoneditor.compileTemplate(
                  this.enumSource[h].title,
                  this.template_engine,
                )),
              this.enumSource[h].filter &&
                (this.enumSource[h].filter = this.jsoneditor.compileTemplate(
                  this.enumSource[h].filter,
                  this.template_engine,
                ));
        }
    ...
    (f.defaults.editors.multiselect = f.AbstractEditor.extend({
      preBuild() {
        ...
        const a = this.jsoneditor.expandRefs(this.schema.items || {});
        const b = a.enum || [];
        for (this.option_keys = [], h = 0; h < b.length; h++)
          this.sanitize(b[h]) === b[h] &&
            (this.option_keys.push(`${b[h]}`),
            (this.select_values[`${b[h]}`] = b[h]));
      },
      build() {
        let a;
        const b = this;
        if (
          ...
          for (
            ...
            (this.inputs[this.option_keys[a]] = this.theme.getCheckbox()),
              (this.select_options[this.option_keys[a]] = this.inputs[
                this.option_keys[a]
              ]);
            const c = this.theme.getCheckboxLabel(this.option_keys[a]);
      ...
      setValue(a, b) {
        ...
        for (
          a = a || [],
            typeof a !== 'object' ? (a = [a]) : Array.isArray(a) || (a = []),
            c = 0;
          c < a.length;
          c++
        )
          typeof a[c] !== 'string' && (a[c] += '');
      ...
      setupSelect2() {
        if (window.jQuery && window.jQuery.fn && window.jQuery.fn.select2) {
          let a = window.jQuery.extend({}, f.plugins.select2);
          this.schema.options &&
            this.schema.options.select2_options &&
            (a = c(a, this.schema.options.select2_options)),
            (this.select2 = window.jQuery(this.input).select2(a));
      ...
      getNumColumns() {
        let a = this.getTitle().length;
        for (const b in this.select_values)
      ...
      updateValue(a) {
        for (var b = !1, c = [], d = 0; d < a.length; d++)
          if (this.select_options[`${a[d]}`]) {
            const e = this.sanitize(this.select_values[a[d]]);
            c.push(e), e !== a[d] && (b = !0);
          } else b = !0;
        return (
          (this.value = c),
    ...
    (f.defaults.editors.base64 = f.AbstractEditor.extend({
      ...
      refreshPreview() {
        if (
          ...
          let a = this.value.match(/^data:([^;,]+)[;,]/);
          if ((a && (a = a[1]), a)) {
            if (
              ((this.preview.innerHTML = `<strong>Type:</strong> ${a}, <strong>Size:</strong> ${Math.floor(
    ...
    (f.defaults.editors.upload = f.AbstractEditor.extend({
      ...
      refreshPreview() {
        if (
          ...
          const a = this;
          let b = this.preview_value.match(/^data:([^;,]+)[;,]/);
          b && (b = b[1]), b || (b = 'unknown');
          const c = this.uploader.files[0];
          if (
            ((this.preview.innerHTML = `<strong>Type:</strong> ${b}, <strong>Size:</strong> ${
              c.size
            } bytes`),
            b.substr(0, 5) === 'image')
          ) {
          ...
          this.preview.innerHTML += '<br>';
          const e = this.getButton('Upload', 'upload', 'Upload');
              ...
              b.preventDefault(),
                ...
                a.jsoneditor.options.upload(a.path, c, {
                  success(b) {
                    a.setValue(b),
                      a.parent
                        ? a.parent.onChildEditorChange(a)
      ...
      setValue(a) {
        this.value !== a &&
          ((this.value = a), (this.input.value = this.value), this.onChange());
      },
      destroy() {
        this.preview &&
          this.preview.parentNode &&
  ...
  (f.AbstractTheme = a.extend({
    ...
    getCheckboxLabel(a) {
      const b = this.getFormInputLabel(a);
      return (b.style.fontWeight = 'normal'), b;
    },
    getHeader(a, b) {
      const c = document.createElement('h3');
      return (
        typeof a === 'string' ? (c.textContent = a) : c.appendChild(a),
        b && (c.className += ' required'),
        c
      );
    },
    getCheckbox() {
      const a = this.getFormInputField('checkbox');
      return (a.style.display = 'inline-block'), (a.style.width = 'auto'), a;
    },
    getMultiCheckboxHolder(a, b, c) {
    ...
    getSwitcherOptions(a) {
      return a.getElementsByTagName('option');
    },
    setSwitcherOptions(a, b, c) {
    ...
    getRangeInput(a, b, c) {
      const d = this.getFormInputField('range');
      return (
    ...
    getCheckboxDescription(a) {
      return this.getDescription(a);
    },
    getFormInputDescription(a) {
      return this.getDescription(a);
    },
    ...
    applyStyles(a, b) {
      a.style = a.style || {};
      for (const c in b) b.hasOwnProperty(c) && (a.style[c] = b[c]);
    },
    closest(a, b) {
      for (; a && a !== document; ) {
        if (!g) return !1;
    ...
    (f.defaults.themes.bootstrap2 = f.AbstractTheme.extend({
      ...
      getFormInputLabel(a, b) {
        const c = this._super(a);
        return (
      ...
      getIndentedPanel() {
        const a = document.createElement('div');
        return (a.className = 'well well-small'), a;
      },
      getFormInputDescription(a) {
        const b = document.createElement('p');
      ...
      getFormControl(a, b, c) {
        ...
        return (
          ...
          a && b.getAttribute('type') === 'checkbox'
            ? (d.appendChild(e),
      ...
      getTab(a) {
        ...
        return (
          c.setAttribute('href', '#'), c.appendChild(a), b.appendChild(c), b
        );
      },
      getTabContentHolder(a) {
        return a.children[1];
      ...
      getProgressBar() {
        ...
        const b = document.createElement('div');
        return (
          (b.className = 'bar'), (b.style.width = '0%'), a.appendChild(b), a
        );
      },
      updateProgressBar(a, b) {
        a && (a.firstChild.style.width = `${b}%`);
      },
      updateProgressBarUnknown(a) {
        a &&
    ...
    (f.defaults.themes.bootstrap3 = f.AbstractTheme.extend({
      ...
      getFormInputField(a) {
        const b = this._super(a);
        return a !== 'checkbox' && (b.className += 'form-control'), b;
      },
      getFormControl(a, b, c) {
        const d = document.createElement('div');
        return (
      ...
      getIndentedPanel() {
        const a = document.createElement('div');
        return (a.className = 'well well-sm'), a;
      },
      getFormInputDescription(a) {
        const b = document.createElement('p');
    ...
    (f.defaults.themes.foundation = f.AbstractTheme.extend({
      ...
      getFormInputField(a) {
        ...
        return (
          (b.style.width = '100%'),
          (b.style.marginBottom = a === 'checkbox' ? '0' : '12px'),
          b
        );
      },
      getFormInputDescription(a) {
      ...
      getProgressBar() {
        ...
        return (
          (b.className = 'meter'), (b.style.width = '0%'), a.appendChild(b), a
        );
      },
      updateProgressBar(a, b) {
        a && (a.firstChild.style.width = `${b}%`);
    ...
    (f.defaults.themes.foundation3 = f.defaults.themes.foundation.extend({
      ...
      getFormInputLabel(a, b) {
        const c = this._super(a);
        return (
          (c.style.fontWeight = 'bold'), b && (c.className += ' required'), c
        );
      },
      getTabHolder() {
        const a = document.createElement('div');
      ...
      getTabContent() {
        const a = document.createElement('div');
        return (
          (a.className = 'content active'), (a.style.paddingLeft = '5px'), a
        );
      },
      markTabActive(a) {
        a.className += ' active';
    ...
    (f.defaults.themes.foundation5 = f.defaults.themes.foundation.extend({
      ...
      getButton(a, b, c) {
        const d = this._super(a, b, c);
        return (
          (d.className = `${d.className.replace(/\s*small/g, '')} tiny`), d
        );
      },
      getTabHolder() {
        const a = document.createElement('div');
    ...
    (f.defaults.themes.html = f.AbstractTheme.extend({
      ...
      addInputError(a, b) {
        if (((a.style.borderColor = 'red'), a.errmsg))
          ...
          const c = this.closest(a, '.form-control');
      ...
      getProgressBar() {
        const a = 100;
        const b = 0;
        const c = document.createElement('progress');
    ...
    (f.defaults.themes.jqueryui = f.AbstractTheme.extend({
      getTable() {
        const a = this._super();
        return (
          a.setAttribute('cellpadding', 5), a.setAttribute('cellspacing', 0), a
        );
      },
      getTableHeaderCell(a) {
        const b = this._super(a);
        return (
          (b.className = 'ui-state-active'), (b.style.fontWeight = 'bold'), b
        );
      },
      getTableCell() {
        const a = this._super();
      ...
      getFormInputDescription(a) {
        const b = this.getDescription(a);
        return (
          (b.style.marginLeft = '10px'), (b.style.display = 'inline-block'), b
        );
      },
      getFormControl(a, b, c) {
        const d = this._super(a, b, c);
    ...
    (f.defaults.templates.default = function() {
      return {
        compile(a) {
          const b = a.match(/{{\s*([a-zA-Z0-9\-_ \.]+)\s*}}/g);
          const c = b && b.length;
          if (!c)
            return function() {
              return a;
          ...
          return function(b) {
            let e;
            let g = `${a}`;
            for (f = 0; c > f; f++) (e = d[f]), (g = g.replace(e.s, e.r(b)));
            return g;
          };
        },
      };
    ...
    (f.defaults.templates.hogan = function() {
      return window.Hogan
        ? {
            compile(a) {
              const b = window.Hogan.compile(a);
              return function(a) {
                return b.render(a);
              };
            },
    ...
    (f.defaults.translate = function(a, b) {
      const c = f.defaults.languages[f.defaults.language];
      if (!c) throw `Unknown language ${f.defaults.language}`;
      let d = c[a] || f.defaults.languages[f.defaults.default_language][a];
      if (typeof d === 'undefined') throw `Unknown translate string ${a}`;
      if (b)
  ...
  for (var h in f.defaults.editors)
    f.defaults.editors.hasOwnProperty(h) &&
      (f.defaults.editors[h].options = f.defaults.editors.options || {});
  f.defaults.resolvers.unshift(function(a) {
    return typeof a.type !== 'string' ? 'multiple' : void 0;
  }),
    f.defaults.resolvers.unshift(function(a) {
      return !a.type && a.properties ? 'object' : void 0;
    }),
    f.defaults.resolvers.unshift(function(a) {
      return typeof a.type === 'string' ? a.type : void 0;
    }),
    f.defaults.resolvers.unshift(function(a) {
      return a.type === 'boolean'
        ? a.format === 'checkbox' || (a.options && a.options.checkbox)
          ? 'checkbox'
          : 'select'
        : void 0;
    }),
    f.defaults.resolvers.unshift(function(a) {
      return a.type === 'any' ? 'multiple' : void 0;
    }),
    f.defaults.resolvers.unshift(function(a) {
      return a.type === 'string' &&
        a.media &&
        a.media.binaryEncoding === 'base64'
        ? 'base64'
        : void 0;
    }),
    f.defaults.resolvers.unshift(function(a) {
    ...
    f.defaults.resolvers.unshift(function(a) {
      return a.type == 'array' && a.format == 'table' ? 'table' : void 0;
    }),
    f.defaults.resolvers.unshift(function(a) {
      return a.enumSource ? 'select' : void 0;
    }),
    f.defaults.resolvers.unshift(function(a) {
      if (a.enum) {
        if (a.type === 'array' || a.type === 'object') return 'enum';
        if (a.type === 'number' || a.type === 'integer' || a.type === 'string')
          return 'select';
      }
    }),
    f.defaults.resolvers.unshift(function(a) {
    ...
    f.defaults.resolvers.unshift(function(a) {
      return a.oneOf ? 'multiple' : void 0;
    }),
    (function() {
      if (window.jQuery || window.Zepto) {
        const a = window.jQuery || window.Zepto;
        (a.jsoneditor = f.defaults),
          (a.fn.jsoneditor = function(a) {
            const b = this;
            let c = this.data('jsoneditor');
            if (a === 'value') {
              if (!c)
